...
export default function Hero() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Best Web Development Company in Chennai | Limonexa Solutions
        </title>
      ...
      <h1 className="hidden text-4xl font-bold text-gray-900">
        Best Web Development Company in Chennai
      </h1>
      <p className=" hidden text-xl text-gray-600">
        Limonexa Solutions provides professional web development, mobile app
        development, and UI/UX design services in Chennai for startups and
        businesses.
      </p>
      <button className="hidden">Hire Web Developers in Chennai</button>
      <section
        id="home"
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 w-full grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 z-10">
            ...
            >
              At Limonexa, we build enterprise-grade software solutions that
              scale with your vision. From innovative startups to industry
              leaders, we deliver excellence.
            </motion.p>

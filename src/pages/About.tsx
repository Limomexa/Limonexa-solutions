          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-gray-500 leading-relaxed">
                Founded on the principles of innovation and integrity, Limonexa
                started with a simple goal: to provide enterprise-grade
                solutions that are accessible to visionaries. We bridge the gap
              ...
              <div className="p-8 overflow-y-auto custom-scrollbar space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600 leading-relaxed font-medium">
                    ...
                    realized that most businesses don't need "another app"—they
                    need a partner who understands their pulse.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    (Connection)**. We believe in bringing fresh perspective to
                    the digital connection points between a business and its
                    customers. We are here to prove that timing and quality
                    matter more than just history.
                  </p>
                </div>
